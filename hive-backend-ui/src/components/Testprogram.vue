...
import { Architecture, type BackendQuery, type BackendQueryTestprogramArgs } from '@/gql/backend';
...
const props = defineProps({
    ...
    selectedArchitecture: {
        type: Object as PropType<Architecture>,
        required: true,
    }
})
...
const compileMessage = computed(() => {
    ...
    switch (props.selectedArchitecture) {
        ...
        case Architecture.Riscv:
            return result.value.testprogram.testprogram.testprogramRiscv.compileMessage;
    }
})
