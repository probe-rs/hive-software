...
<template>
    <v-card elevation="1">
        ...
        <v-card-text class="pb-0">
            <v-autocomplete :items="targetRegistry" dense label="Chip model" hint="Please select the appropriate chip"
                persistent-hint no-data-text="No matching models found"></v-autocomplete>
        </v-card-text>
        ...
        <v-overlay v-model="loading" persistent contained class="align-center justify-center">
